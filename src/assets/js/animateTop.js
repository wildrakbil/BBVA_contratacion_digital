class CustomAnimateTo {
  constructor (desiredOffset, options) {
    ...
    if (desiredOffset instanceof HTMLElement) {
      if (userOptions.element && userOptions.element instanceof HTMLElement) {
        desiredOffset = ((desiredOffset.getBoundingClientRect().top + userOptions.element.scrollTop) - userOptions.element.getBoundingClientRect().top) + options.offsetY
      } else {
        var scrollTop = window.scrollY || document.documentElement.scrollTop
        desiredOffset = scrollTop + desiredOffset.getBoundingClientRect().top + options.offsetY
      }
    }
...
export default CustomAnimateTo
